...
# By default all these toolchains are registered by the kcl_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:kcl_toolchain",
    toolchain_type = "@org_kcl_lang_rules_kcl//kcl:toolchain_type",
)
""".format(
            platform = platform,
