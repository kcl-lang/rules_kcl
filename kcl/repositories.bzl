...
load("//kcl/private:toolchains_repo.bzl", "PLATFORMS", "toolchains_repo")
...
########
_DOC = "Fetch external tools needed for KCL toolchain"
_ATTRS = {
    "kcl_version": attr.string(mandatory = True, values = TOOL_VERSIONS.keys()),
    "platform": attr.string(mandatory = True, values = PLATFORMS.keys()),
}

def _kcl_repo_impl(repository_ctx):
...
load("@org_kcl_lang_rules_kcl//kcl:toolchain.bzl", "kcl_toolchain")
kcl_toolchain(name = "kcl_toolchain", kcl = "kcl")
"""

    # Base BUILD file for this repository
    repository_ctx.file("BUILD.bazel", build_content)

kcl_repositories = repository_rule(
    _kcl_repo_impl,
    doc = _DOC,
    attrs = _ATTRS,
)
...
def kcl_register_toolchains(name, kcl_version, register = True, **kwargs):
    ...
    Args:
        name: base name for all created repos, like "kcl1_0_0"
        kcl_version: the specific KCL version to use, e.g. "1.0.0"
